...
import ExplorationModal from '../features/itemMap/exploration/index.jsx';
import PlantModal from '../features/itemMap/plant/PlantModal.jsx';
...
export default function MapPage() {
  ...
  // ── UI 状态 ───────────────────────────────────────────────
  const [openModal, setOpenModal] = useState(null);  // 'zoneDetail'|'zoneNew'|'stats'|'exploration'|'plant'|null
  ...
  return (
    <>
      ...
      {/* 衣柜入口 */}
      <NavButton onClick={() => navigate('/wardrobe')} title="衣柜">👗</NavButton>

      {/* 记账入口 */}
      <NavButton onClick={() => navigate('/finance')} title="记账" top="60px">
        💰
      </NavButton>
