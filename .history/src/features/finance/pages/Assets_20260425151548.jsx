                                                    ...
                                                    {isEditing && !isEditMode && (
                                                        <input
                                                            ...
                                                            style={{ 
                                                                ...
                                                                background: 'transparent',
                                                                // 不设 height: 100%，让 edit-naked-input 的 height: auto 生效
                                                                // 这样输入框只占据自身必须的 20多像素高度，不会贪婪填满 td
                                                            }}
                                                        />
                                                    )}
                                                </td>
...
const TD_STYLE = {
    border: `1px solid ${BORDER_COLOR}`,
    // 增大上下内边距，包容原生输入框的极限微小高度，彻底消灭跳动
    padding: '12px 10px',
    textAlign: 'center',
    verticalAlign: 'middle', // 极其重要：确保输入框在富余空间里垂直居中，不乱顶
