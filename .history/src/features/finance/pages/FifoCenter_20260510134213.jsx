        ...
        <div className="flex-1 flex flex-col min-h-[400px] mb-8">
          <div className="flex justify-between items-center mb-6">
            ...
            <div className="flex gap-4 text-[11px] font-medium text-on-surface-variant">
              ...
              <div className="flex items-center gap-1.5"><div className="w-4 h-[2px] rounded-full bg-[#959c9f] border-t border-dotted"></div>全部</div>
              ...
              >
                ...
                <div className="col-span-3 flex items-center justify-end" onClick={e => e.stopPropagation()}>
                  <input 
                    ...
                    className="number-input-clean w-full bg-transparent border-none text-right font-mono-num text-[13px] font-bold text-on-surface-variant focus:ring-0 focus:text-primary p-1 h-6 transition-colors hover:bg-surface-variant/50 rounded"
                  />
                </div>
