            ...
            <div id="details" className="card">
                ...
                <div style={{ overflowX:'auto' }}>
                    <table className="table">
                        <thead>
                            <tr>
                                <th style={{ width:110, cursor:'pointer', userSelect:'none' }} onClick={() => setSortDesc(v => !v)}>
                                    日期 <i className={sortDesc ? 'ri-sort-desc' : 'ri-sort-asc'} />
                                </th>
                                <th style={{ width:60 }}>类型</th>
                                <th style={{ width:80 }}>一级</th>
                                <th style={{ width:160 }}>二级</th>
                                <th>说明</th>
...
function TxRow({ tx: t, colorMap, cats, editingTxId, editFormData, setEditFormData, onStartEdit, onSaveEdit, onCancelEdit, onDelete }) {
    ...
    return (
        <tr>
            <td data-label="日期" className="td-edit-wrap" style={{ width:'110px', flexShrink:0 }}>
                {isEditing ? (
                    <input
                        type="date"
                        className="edit-naked-input"
                        style={{ width:'100%', minWidth:0, boxSizing:'border-box', height:'auto', minHeight:0 }}
            ...
            <td data-label="二级" className="td-edit-wrap">
                {isEditing ? (
                    <select
                        ...
                        style={{ width:130, appearance:'none', WebkitAppearance:'none', MozAppearance:'none', height:'auto', minHeight:0 }}
