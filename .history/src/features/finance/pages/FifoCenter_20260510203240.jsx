...
export default function FifoCenter() {
  ...
  return (
    <div className="flex-1 h-full flex flex-col lg:flex-row overflow-y-auto lg:overflow-hidden relative bg-surface text-primary antialiased">
       ...
       <section className="w-full lg:w-[65%] h-auto lg:h-full flex flex-col p-6 lg:px-12 lg:py-6 overflow-visible lg:overflow-y-auto border-0 border-b-[1px] lg:border-b-0 lg:border-r-[1px] border-solid border-surface-variant relative z-10 shrink-0">
        ...
        <div className="flex-1 flex flex-col min-h-[220px] mb-4 lg:mb-6">
          <div className="flex justify-between items-center mb-6">
            ...
            <div className="flex flex-wrap items-center gap-4 text-[11px] font-medium text-on-surface-variant">
              {/* 核心线条指标 */}
              <div className="flex items-center gap-1.5"><div className="w-4 h-[2px] rounded-full bg-tertiary-container"></div>总支</div>
              <div className="flex items-center gap-1.5"><div className="w-4 h-[2px] rounded-full bg-[#d1a054]"></div>生活开销</div>
              <div className="flex items-center gap-1.5"><div className="w-4 h-[2px] rounded-full bg-outline opacity-50 border-t border-dashed"></div>本周预算</div>
              
              <div className="w-px h-3 bg-surface-variant mx-1"></div> {/* 分隔线 */}
              
              {/* 柱状成分拆解 */}
              <div className="flex items-center gap-1.5"><div className="w-2.5 h-2.5 rounded-sm bg-secondary"></div>预算内消耗</div>
              <div className="flex items-center gap-1.5"><div className="w-2.5 h-2.5 rounded-sm bg-secondary-fixed-dim"></div>动用结余</div>
              <div className="flex items-center gap-1.5"><div className="w-2.5 h-2.5 rounded-sm bg-error"></div>严重透支</div>
            </div>
          </div>
