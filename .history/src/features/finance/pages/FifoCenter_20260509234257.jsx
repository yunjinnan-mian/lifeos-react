...
export default function FifoCenter() {
  ...
  return (
    <div className="flex-1 h-full flex flex-col lg:flex-row overflow-y-auto lg:overflow-hidden relative bg-surface text-primary antialiased">
      ...
      <section className="w-full lg:w-[65%] h-auto lg:h-full flex flex-col p-6 lg:p-12 overflow-visible lg:overflow-y-auto border-b-[1px] lg:border-b-0 lg:border-r-[1px] border-solid border-surface-variant relative z-10 shrink-0">
        ...
        {/* 恢复底部的 本周结余 + 周均消费 */}
        <div className="grid grid-cols-2 gap-8 pt-8 border-t-[1px] border-surface-variant mt-auto">
          {(() => {
      ...
      <section className="w-full lg:w-[35%] h-auto lg:h-full min-h-[500px] lg:min-h-0 relative overflow-hidden bg-surface-bright shrink-0 z-10 flex flex-col">
        ...
        <div className={`flex-1 h-full flex flex-col p-6 lg:p-12 transition-transform duration-300 ease-in-out ${activeWeekNum ? '-translate-x-full' : 'translate-x-0'}`}>
          ...
          <div className="grid grid-cols-12 gap-2 pb-4 border-b-[1px] border-surface-variant text-[10px] uppercase tracking-widest font-semibold text-on-surface-variant pr-2">
