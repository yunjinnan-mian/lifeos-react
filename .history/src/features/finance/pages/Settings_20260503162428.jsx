    ...
    return (
        <div className="settings-page">
            ...
            {groupNames.map(groupName => {
                ...
                return (
                    <div key={groupName} className="card settings-group-card" style={{ marginBottom: 16, padding: 16 }}>
                        {/* ── 一级标题行 ───────────────────── */}
                                ...
                                {isEditing && editGroup === groupName ? (
                                    <input
                                        ...
                                        onChange={e => {
                                            ...
                                            // 更新该组所有 cat 的 group 字段
                                            catList.forEach(c => {
                                                handleCatFieldChange(c.id, 'group', newName);
                                            });
            ...
            {/* ── 新增一级 ─────────────────────────────────── */}
            {isEditing && (
                <div className="card" style={{ marginBottom: 16, padding: 16, textAlign: 'center', borderStyle: 'dashed' }}>
                    {showNewGroup ? (
