            ...
            <table style={{ 
                ...
                <thead>
                    ...
                    <tr>
                        ...
                        {/* 行内添加账户表头 */}
                        <th style={{ ...TH_STYLE, background: '#f8fafc', width: 120 }}>
                            {showAddAcc ? (
                                <input
                                    autoFocus
                                    placeholder="输入回车"
                                    ...
                                    style={{ width:'100%', padding:'2px', fontSize:12, textAlign:'center' }}
                                />
                            ) : (
                                <button 
                                    onClick={() => setShowAddAcc(true)}
                                    style={{ background:'none', border:'none', color:'#3b82f6', cursor:'pointer', width:'100%', fontWeight:'bold' }}
                                >+ 增加账户</button>
                            )}
                        </th>
                        <th style={{ ...TH_STYLE, color:'#10b981' }}>Σ 总合计</th>
                        <th style={TH_STYLE}>资产变动</th>
                    </tr>
                            ...
                            {accounts.map(acc => {
                                ...
                                return (
                                    <td 
                                        ...
                                        style={{ ...TD_STYLE, cursor:'text', background: isEditing ? '#fff' : 'transparent' }}
                                    >
                                        {isEditing ? (
                                            <input
                                                ref={inputRef}
                                                ...
                                                style={{ width:'100%', textAlign:'right', border:'1px solid #3b82f6', outline:'none', padding:'2px', fontSize:13 }}
                                            />
                                        ) : (
                                            <span style={{ color: val ? '#0f172a' : '#cbd5e1' }}>
                                                {val ? fmt(val) : '—'}
                                            </span>
                                        )}
                                    </td>
                        ...
                        <td style={{ ...TD_STYLE, textAlign:'center', padding: '6px' }}>
                            <input
                                ...
                                onChange={e => {
                                    ...
                                    if(e.target.value) handleAddSnapshot(e.target.value); // 选完日期自动生成行
                                }}
