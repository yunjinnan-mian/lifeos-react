...
export default function FifoCenter() {
  ...
  return (
    <div className="flex-1 h-full flex flex-col lg:flex-row overflow-y-auto lg:overflow-hidden relative bg-surface text-primary antialiased">
      ...
      <section className="w-full lg:w-[65%] h-auto lg:h-full flex flex-col p-6 lg:p-12 overflow-visible lg:overflow-y-auto border-b-[1px] lg:border-b-0 lg:border-r-[1px] border-surface-variant relative z-10 shrink-0">
