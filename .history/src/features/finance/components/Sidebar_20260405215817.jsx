        ...
        <>
            ...
            <div className={sidebarCls} id="sidebar">
                ...
                <div style={{ marginTop: 'auto', borderTop: '1px solid rgba(255,255,255,0.08)', paddingTop: 10 }}>
                    <button className="nav-item" onClick={() => { onOpenReceipt?.(); closeMobile(); }}>
                        <i className="ri-receipt-line" /><span>生成月度小票</span>
                    </button>
                    <button className="nav-item" onClick={() => { onOpenCatModal?.(); closeMobile(); }}>
                        <i className="ri-price-tag-3-line" /><span>分类管理</span>
                    </button>
