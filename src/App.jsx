...
import { db, DB, collection, doc, onSnapshot, query, where } from './firebase.js';
import { buildWorldGrid, addRipple, applyZoomStep, getZoomValue } from './engine/mapEngine.js';
import { warmupBgModel, processPhoto, bgModelStatus, setAiStatusCallback } from './utils/photo.js';
...
export default function App() {
  ...
  // ── Zone CRUD ─────────────────────────────────────────────
  async function handleSaveNewZone(name, emoji) {
